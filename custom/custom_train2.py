...
cfg.data.val.data_root = './data/kitti/'
cfg.data.val.ann_file = 'val.txt'
cfg.data.val.img_prefix = 'training/image_2'

cfg.data.test.type = 'KittiDataset'
cfg.data.test.data_root = './data/kitti/'
...
import cv2
# BGR Image 사용 
img = cv2.imread('./data/kitti/testing/image_2/000068.png')
model.cfg = cfg
result = inference_detector(model, img)
# show_result_pyplot(model, img, out_file="test.jpeg")
model.show_result(img, result, out_file="./test_2.jpeg")
